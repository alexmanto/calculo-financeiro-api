...
namespace CalculoFinanceiro.Juros.Api.V1.Models
{
    ...
    public class CalculaJurosDTO
    {
        ...
        /// </summary>
        [Required(ErrorMessage = "O parâmetro valorinicial precisa ser informado.")]
        [Range(0.1, (double)decimal.MaxValue, ErrorMessage = "O valor do parâmetro valorinicial precisa ser maior que zero.")]
        ...
        /// </summary>
        [Required(ErrorMessage = "O parâmetro meses precisa ser informado.")]
